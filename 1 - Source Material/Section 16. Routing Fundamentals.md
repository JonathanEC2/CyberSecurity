...
Local  routes are also called host routes
## show ip route 
...
On a router, the `ip default-network address` command can be used in place of the` ip route `command to configure a gateway of last resort.
# Lab Info
