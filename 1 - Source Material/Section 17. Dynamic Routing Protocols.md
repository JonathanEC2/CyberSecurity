...
- <span style="color:rgb(255, 0, 0)">We might want to configure a static route as a backup for the route learned via a routing protocol. For example, maybe we are worried the entire routing protocol will go down </span>
