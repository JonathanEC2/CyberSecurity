...
A technology called VLAN (Virtual Local Area Network) allows specific devices within a network to be virtually split up. [[3. Network and System Security#Need for Secure Segmentation]]
